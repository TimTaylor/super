...
# lines containing only indentation are handled properly
# Notes from original glue repo:
...
# indent counter resets at newline"
...
# trailing whitespace-only line doesn't goof up indentation
expect_identical(trim("\n  A\n\n"), "A\n")
# comment in trim_() says:
# "if the line consists only of tabs and spaces, and if the line is
#  shorter than min_indent, copy the entire line"
